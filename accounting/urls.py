...
from accounting.views import (ShopLogisticUnitView, ShopManagersInformation, ShopManagersInformationV2, ShopInformation,
                              UserMobile, ProductStats, UserStats, InvoiceStats, BuyersInfo, InvoicesInfo)
...
urlpatterns = [
    ...
    path('buyers-info/', BuyersInfo.as_view(), name='buyers_information'),
    path('invoices-info/', InvoicesInfo.as_view(), name='invoices_information'),
]