...
checkFieldsSendInfo = function () {
    var checks = true;
    if (document.querySelector('#inputNationalCode').value !== '') {
        // debugger
        let meli_code = document.querySelector('#inputNationalCode').value;
        if (meli_code.length == 10) {
            if (meli_code == '1111111111' ||
                ...
                $("#alert-div-inputNationalCodeFormat-Persian").show();
                $("#alert-div-inputNationalCode-Persian").hide();
                $("#alert-div-inputNationalCodeError-Persian").hide();
                checks = false;
