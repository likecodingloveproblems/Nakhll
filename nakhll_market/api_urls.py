...
from nakhll_market.api import (
    ...
    LandingPageSchemaViewSet, ShopPageSchemaViewSet, ShopsStatisticViewSet, TagsOwnerProductViewSet
)
...
shop_owner_router.register(r'tags', TagsOwnerProductViewSet, basename="tags")
