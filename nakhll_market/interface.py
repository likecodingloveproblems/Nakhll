...
class DiscordAlertInterface:
    ...
    def new_product(product):
        ...
        embed.add_embed_field(name='قیمت', value='{:,}'.format(product.Price), inline=False)
        embed.add_embed_field(name='قیمت با تخفیف', value='{:,}'.format(product.OldPrice), inline=False)
