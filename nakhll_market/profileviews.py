...
def ProfileFactor(request):
    ...
    if request.user.is_authenticated :
        ...
        # Factor List
        factor_items_wait = Factor.objects.filter(PaymentStatus = True, Publish = True, Checkout = False, FK_FactorPost__ProductStatus = '0', FK_FactorPost__FK_Product__FK_Shop__FK_ShopManager=request.user).distinct()
        factor_items_ready = Factor.objects.filter(PaymentStatus = True, Publish = True, Checkout = False, FK_FactorPost__ProductStatus = '1', FK_FactorPost__FK_Product__FK_Shop__FK_ShopManager=request.user).distinct()
        factor_items_send = Factor.objects.filter(PaymentStatus = True, Publish = True, Checkout = False, FK_FactorPost__ProductStatus = '2', FK_FactorPost__FK_Product__FK_Shop__FK_ShopManager=request.user).distinct()
        factor_items_cansel = Factor.objects.filter(PaymentStatus = True, Publish = True, Checkout = False, FK_FactorPost__ProductStatus = '3', FK_FactorPost__FK_Product__FK_Shop__FK_ShopManager=request.user).distinct()
